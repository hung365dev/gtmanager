...
public class UIButtonColor : UIWidgetContainer
{
	...
	public void UpdateColor (bool instant)
	{
		...
		if (tweenTarget != null)
		{
			switch (mState)
			{
				case State.Hover: tc = TweenColor.Begin(tweenTarget, duration, hover);
				if(gameObjectToDisableOnDisable!=null) {
					gameObjectToDisableOnDisable.SetActive(true);
				}
				break;
				case State.Pressed: tc = TweenColor.Begin(tweenTarget, duration, pressed); 
				if(gameObjectToDisableOnDisable!=null) {
					gameObjectToDisableOnDisable.SetActive(true);
				}
				break;
				case State.Disabled: tc = TweenColor.Begin(tweenTarget, duration, disabledColor);
				if(gameObjectToDisableOnDisable!=null) {

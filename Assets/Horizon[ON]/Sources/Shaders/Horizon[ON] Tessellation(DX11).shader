...
[BlockInfo(1.0,1.0,1.0,1.0)] dummy_begin ("Features", Float) = 1
	    ...
	    [KeywordEnum(Ambient, Cubemap, SkyshopSH, Unity5SH)] _IBLDiff ("   Diffuse Ambient Lighting Mode", Float) = 0
...
[BlockInfo(1.0,1.0,1.0,1.0, 1, indent)] dummy_displacement ("Displacement", Float) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma shader_feature _IBLDIFF_AMBIENT _IBLDIFF_CUBEMAP _IBLDIFF_SKYSHOPSH _IBLDIFF_UNITYSH
...
//            #pragma shader_feature _SNOW_OFF _SNOW_ON
    ...
    FallBack "Becoming/horizON/horizON_ObjectDisplacement"
}
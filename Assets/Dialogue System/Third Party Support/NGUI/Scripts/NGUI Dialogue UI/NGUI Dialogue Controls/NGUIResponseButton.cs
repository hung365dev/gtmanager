...
namespace PixelCrushers.DialogueSystem.NGUI {
	...
	public class NGUIResponseButton : MonoBehaviour {
		...
		public bool clickable {
			get { return (nguiButton != null) && nguiButton.isEnabled; }  //---Was: { return (collider != null) ? collider.enabled : false; }
			set { if (nguiButton != null) nguiButton.isEnabled = value; } //---Was: { if (collider != null) collider.enabled = value; }
		}

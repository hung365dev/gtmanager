...
namespace GoogleFu
{
	...
	public class CarLibraryRow : IGoogleFuRow
	{
		...
		public CarLibraryRow(string __id, string __carname, string __carprefabname, string __carcost, string __carstyle, string __carhp, string __carhprpm, string __cartorque, string __cartorquerpm, string __carshiftspeed, string __caraero, string __carfrontwing, string __carrearwing, string __cartireweareffect, string __cardrivabilityeffect) 
		{
			{
			int res;
			...
			{
			float res;
				if(float.TryParse(__cartorque, out res))
					_cartorque = res;
				else
					Debug.LogError("Failed To Convert cartorque string: "+ __cartorque +" to float");
			}
			{
			float res;
		...
		public override string ToString()
		{
			...
			ret += "{" + "cartorque" + " : " + _cartorque.ToString() + "} ";
